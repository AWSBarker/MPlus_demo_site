...
p = figure(plot_width=800, plot_height=120, title=f"Total vs Active devices by Org, for {by} and {mtd_txt}",
...
label1 = Label(x=1, y=100, text='Total ', text_color='black', text_font_size = '11px', y_offset=15)
label2 = Label(x=1, y=100, text='Active ', text_color='black', text_font_size = '11px',y_offset=-30)
Tlabels = LabelSet(x='xaxis', y=100, text='Tlab', x_offset=18, y_offset=15,
                  source=spie, text_color='black', text_font_size = '11px')
...
p1 = figure(plot_width=800, plot_height=300, x_range =  p.x_range,
            title="Current active devices by Org by week",
...
p1.xaxis[0].formatter = FuncTickFormatter(code="""
    ...
    """)
p1.xaxis[0].major_label_text_font_size ='8px'
#p1.xaxis[0].major_tick_line_color = None
p1.xaxis[0].group_text_font_size = '15px'
p1.xaxis[0].major_label_orientation = "vertical"
p1.xgrid.visible = False
p1.ygrid.visible = False

p2 = figure(plot_width=800, plot_height=300, title="All Orgs : active devices by week", outline_line_color=None, toolbar_location=None, tools="", x_range=source_org_stack_wk.data['xaxis'])
...
data_table = DataTable(source=source_org_stack_wk, columns=columns, width=650, index_position=None)
