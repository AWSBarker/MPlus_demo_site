...
orgs_wk = pickle.loads(r.get("df_M2_orgs_wk"))
dfpie = pickle.loads(r.get("df_M2_dfpie"))
org_stack_wk = pickle.loads(r.get("df_M2_org_stack_wk"))
...
p = figure(plot_width=800, plot_height=120, title=f"GM : Total vs Active devices by Org, for ",
