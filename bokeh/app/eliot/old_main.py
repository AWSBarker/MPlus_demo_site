...
from bokeh.models import CDSView, GroupFilter, BooleanFilter, ColumnDataSource, Select,  \
    ...
    Legend, DataTable, TableColumn, DateFormatter
...
ecg_devices = dfecg_pdf.IMEI.unique().tolist()
...
pan1 = Panel(child=layout1, title = 'BP800/D40g, LS802')
...
pan2 = Panel(child=layout2, title = 'BC800, BS2001')
