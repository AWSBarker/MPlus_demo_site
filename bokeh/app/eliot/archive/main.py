...
dba = db_get("SELECT device_IMEI, measurements_timestamp, measurements_pulse_value, measurements_systolicBloodPressure_value,"
          " measurements_diastolicBloodPressure_value, measurements_glucose_value, measurements_bodyWeight_value, "
...
weights = figure(plot_height=350, plot_width= 480, x_axis_type="datetime", y_axis_label='Kg', tools=TOOLS, toolbar_location = 'above', title = '3. Select your weight measurements')
...
bodycomp = figure(plot_height=350, plot_width= 550,x_axis_type="datetime", y_axis_label='Body Composition estimate', toolbar_location = None, y_range=(0,130), title='5. Body composition for selected measurements')
bodycomp.varea_stack(stackers=['fat', 'mus', 'h20', 'bone'], x = 'ts', source=source3, color=['yellow', 'brown', 'blue', 'grey'])#brewer['Spectral'][4]) #, view=view)
...
bodycomp.line(x='ts', y='bmr', line_width = 4, line_color='black', y_range_name='foo', legend_label='metabolic rate', source=source3)
