...
d = {'x' : [0.5], 'y' : [0],  'd1' : [str(Clock1['b'])[2:]], 'd2' : [str(Clock2['b'])[2:]]}
data1 = ColumnDataSource(data=d)

plot1 = figure(x_range=(-0.5,1), plot_width=400, plot_height=200, background_fill_color = None, tools = '')
plot1.text(x = 'x', y = 'y', text = 'd1', text_font_size = '5em', angle = 3.141, source = data1)
plot1.xgrid.grid_line_color = None
plot1.ygrid.grid_line_color = None
plot1.axis.visible = False

plot2 = figure(x_range=(0,2), plot_width=400, plot_height=200, background_fill_color = 'black', tools = '')
