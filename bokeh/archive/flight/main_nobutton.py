...
def steps(value):
    ...
    try:
        b = Update(location,planes)
        rob = len(b.ss) * 5
        print(f'step count {value}. tracker points= {rob}, details {b.own}')
...
p = figure(x_range=a.get_xrange(), y_range=a.get_yrange(), x_axis_type="mercator", y_axis_type="mercator", tooltips=TOOLTIPS, name = 'g1')
