...
#folder1="/nfs/all/Acer/bokeh/examples/app/c19/data"
...
print(f'df ready {time.time() - start}')  # ~ 11s
...
print(f'all loaded ready to plot {time.time()-start}') # ~ 15.5s
...
plot1 = figure(plot_height=200, x_axis_type="datetime", y_axis_label='cases', title = 'Cases, Deaths, Daily changes, Post peak regional comparison',
               tools="save", toolbar_location="above")
...
plot3 = figure(plot_height=400, plot_width = 640, x_axis_type='linear', x_range = (-5,180),
               x_axis_label='days since highest peak', y_axis_label='Post peak case ratio (country/region) Peak = 1',
               y_range = (0, 1.1), tooltips=TOOLTIPS, tools="save, pan, reset", toolbar_location="above")

plot3.circle(x = 'id', y = 'dfm_cmax', size=2, source = source1, view = view3) #plot3.line(x='id', y='dfm_cmax', source=source1, view=view3)
