...
from bokeh.models import ColumnDataSource, Select, CDSView, GroupFilter, BooleanFilter, DatetimeTickFormatter, LabelSet
...
plot3 = figure(plot_height=400, plot_width = 800, x_axis_type='linear', x_range = (-10,postpeakd), x_axis_label='days since highest peak', y_axis_label='Post peak case ratio (country/region) Peak = 1', y_range = (0, 1.1), tooltips=TOOLTIPS, tools="pan, save", toolbar_location="above")
