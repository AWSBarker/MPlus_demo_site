...
plot = figure(plot_height=400, plot_width=640, title='Top 5 causes of death vs C19', tools="save", toolbar_location="right")
...
plot3 = figure(plot_height=400, plot_width = 600, title = 'Regional comparison of Post peak performance', x_axis_type='linear',
               x_range = (-1,postpeakd), x_axis_label='days since peak',
               y_axis_label='Post peak case ratio (country/region) Peak = 1', y_range = (0, 1.1),
               tooltips=TOOLTIPS, tools="save", toolbar_location="above")
plot3.line(x='id', y='dfm_cmax', source=source1, view=view3)
plot3.line(x='id', y='dfm_cmax', source=source1, view=view4, color = 'red', line_width = 3.0) #,  color = Category20)
