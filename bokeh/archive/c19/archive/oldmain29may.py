...
plot3 = figure(plot_height=400, plot_width = 600, x_axis_type='linear', x_range = (-1,postpeakd), x_axis_label='days since peak', y_axis_label='Post peak case ratio (country/region) Peak = 1', y_range = (0, 1.1), tooltips=TOOLTIPS, tools="save", toolbar_location="above")
