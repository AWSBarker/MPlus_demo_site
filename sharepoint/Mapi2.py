...
class LoginSession:
    ...
    - .ENV FILE REQUIRED in '/home/bitnami/sharepoint' (M_awsb for dev)
    - configs for dev by os.uname()[1] =='VESA-ubuntu':
    """
    lookup_config = {'VESA-ubuntu' : '/media/Data2/ownCloud/PycharmProjects/M_awsb/sharepoint',
                     'ThinkPad-E470' : '/home/andrew/ownCloud/PycharmProjects/sharepoint',
                     'awsbarker.ddns.net': '/home/pi/ownCloud/PycharmProjects/M_awsb/sharepoint',
                     'awsb.ddns.net': '/home/ab/ownCloud/PycharmProjects/M_awsb/sharepoint',
    ...
    print(lookup_config.get(os.uname()[1]))
...
class Dev(Mapi):
    ...
    @staticmethod
    def getdev_owner(): # to get updated owner  Org(o).getalldevs()
...
if __name__ == "__main__":
    ...
    orgs = Org().get_all_orgs()
    gmorgs = Org().getGMOrgs()
# Al 2a4f9541-61ce-463b-9e51-3df5cc2a49c8
# Eumaco '872b62b0-9527-4e1b-9822-
    al = Org('2a4f9541-61ce-463b-9e51-3df5cc2a49c8')
    aldevs = al.get_org_fleet()

    alLoT = al.alldev_as_LoT(aldevs)
    for d in al:
        try :
            if d['gatewayID']:
