...
def url_shutil():
    ...
    while tday in daysback:
        ...
        #https://aact.ctti-clinicaltrials.org/static/exported_files/daily/20220623_pipe-delimited-export.zip
        aurl = "https://aact.ctti-clinicaltrials.org/static/exported_files/monthly/20170105_pipe-delimited-export.zip"
        #tf = tempfile.TemporaryFile()#downfile = '1.zip'
